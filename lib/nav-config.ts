...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'AI Prompt Studio', icon: MessageSquare, href: '/dashboard/thumbnail-studio/ai-prompts', badge: 'New' },
      { label: 'Template Marketplace', icon: Store, href: '/dashboard/thumbnail-studio/templates', badge: 'New' },
    ],
  },
  {
    title: 'SEO Studio',
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'AI Agent', icon: Bot, href: '/dashboard/automation/agent' },
      { label: 'Scheduled Jobs', icon: Timer, href: '/dashboard/automation/jobs' },
      { label: 'API Integration', icon: Plug, href: '/dashboard/automation/api' },
    ],
  },
  {
    title: 'Assets',
    items: [
      { label: 'Assets', icon: FolderOpen, href: '/dashboard/assets' },
    ],
  },
  {
    title: 'System',
