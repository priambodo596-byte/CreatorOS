...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Draft', icon: FileEdit, href: '/dashboard/content?status=draft' },
      { label: 'Scheduled', icon: Send, href: '/dashboard/content?status=scheduled' },
      { label: 'Published', icon: CheckCircle2, href: '/dashboard/content?status=published' },
      { label: 'Archived', icon: Archive, href: '/dashboard/content?status=archived' },
