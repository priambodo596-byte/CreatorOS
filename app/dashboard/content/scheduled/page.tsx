...
export default function ScheduledContentPage() {
  ...
  const [rescheduleTarget, setRescheduleTarget] = useState<ContentItem | null>(
    null
  );
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to load scheduled content"
      );
    } finally {
      setLoading(false);
    }
  ...
  async function handleReschedule() {
    if (!rescheduleTarget || !rescheduleDate) {
      toast({ title: "Please select a new date/time", variant: "destructive" });
      return;
    }
    try {
      await updateContent(rescheduleTarget.id, {
  ...
  async function handleArchive() {
    ...
    try {
      ...
      toast({ title: "Scheduled content archived" });
  ...
  return (
    <div className="space-y-6 p-4 md:p-6 lg:p-8">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        {overdueCount > 0 && (
          <Card className="glass flex items-center gap-3 px-4 py-3 border-destructive/30">
      ...
      {overdueCount > 0 && (
        <Card className="glass p-4 border-destructive/30">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium">
                {overdueCount} scheduled item(s) past their scheduled time
              </p>
              <p className="text-xs text-muted-foreground">
                Publish now or reschedule to a new date.
              </p>
            </div>
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="scheduled_at">Schedule Date</SelectItem>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description="Schedule your content to publish at a specific date and time."
          action={
            <Link href="/dashboard/content">
              <Button size="sm">
            ...
            <TableBody>
              {items.map((item) => (
                <TableRow
                  key={item.id}
                  className={
                    isOverdue(item.scheduled_at) ? "bg-destructive/5" : ""
                  }
                >
                  <TableCell>
                    <Checkbox
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              &quot;{publishTarget?.title}&quot; will be published immediately instead of
              its scheduled time.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() =>
                publishTarget && handlePublishNow(publishTarget.id)
              }
            >
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Choose a new date and time for &quot;{rescheduleTarget?.title}&quot;.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className="py-4">
            <Input
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem onClick={() => onPublishNow(item)}>
...
function ScheduledCard({
  ...
  const overdue = item.scheduled_at && new Date(item.scheduled_at) < new Date();
  return (
    <Card
...
function ScheduledRow({
  ...
  return (
    <Card
      className={`glass glass-hover flex items-center gap-4 p-3 ${
        overdue ? "border-destructive/30" : ""
      }`}
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-1 flex items-center gap-2 text-xs text-muted-foreground">
          <Clock className={`h-3 w-3 ${overdue ? "text-destructive" : ""}`} />
