...
export function DashboardTopbar() {
  ...
  const [notifications] = useState([
    { id: 1, title: 'Video published successfully', time: '2m ago', type: 'success' },
    { id: 2, title: 'AI script generation complete', time: '15m ago', type: 'info' },
    { id: 3, title: 'New trending topic detected', time: '1h ago', type: 'warning' },
  ]);
